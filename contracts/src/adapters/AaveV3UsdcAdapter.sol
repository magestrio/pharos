...
/// @dev `valueInUsdc()` returns the aUSDC balance directly. aUSDC is a 1:1
///      rebasing receipt token for USDC supplied to Aave V3, so no oracle
///      pricing is needed. The position grows monotonically via interest
///      accrual reflected in aUSDC.balanceOf.
