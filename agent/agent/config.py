...
class Settings(BaseSettings):
    ...
    AAVE_V3_USDC_ADAPTER_ADDRESS: str = "0x0000000000000000000000000000000000000000"
    AAVE_V3_WETH_ADAPTER_ADDRESS: str = "0x0000000000000000000000000000000000000000"
